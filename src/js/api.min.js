...
$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,c){return $jscomp.findInternal(this,a,c).v}},"es6","es3");String.prototype.hashCode=function(){var a=0;if(0===this.length)return a;var b=0;for(l=this.length;b<l;b++){var c=this.charCodeAt(b);a=(a<<5)-a+c;a|=0}return a};String.prototype.deres=function(){return this.replace(/img[^>]*>/g,"")};String.prototype.decamel=function(){return this.replace(/(?=[a-zA-z])(?=[A-Z])/g,"-").toLowerCase()};
String.prototype.matchAny=function(a){var b=this,c=!1;$.each(a,function(a,e){if(b.match(e))return c=a,!1});return c};Array.prototype.unique=function(){return this.reduce(function(a,b){0>a.indexOf(b)&&a.push(b);return a},[])};Array.prototype.diff=function(a){return this.reduce(function(b,c){-1==a.indexOf(c)&&b.push(c);return b},[])};function handle(a,b,c,d){a=$(a);a.off(b);a.on(b,c)}
function getBlob(a,b){var c=new XMLHttpRequest;c.open("GET",a,!0);c.responseType="blob";c.onload=function(){var a=window.URL.createObjectURL(this.response);b(a)};c.send()}
function getDataUri(a,b,c){"undefined"==typeof c&&(c=b,b=!1);var d=new Image;d.onload=function(){var a=document.createElement("canvas");a.width=this.naturalWidth;a.height=this.naturalHeight;var d=a.getContext("2d");d.drawImage(this,0,0);if(b){var g=a.width/2,h=a.height/2,k=new Image;k.onload=function(){d.fillStyle="white";d.fillRect(g,h,g,h);d.drawImage(this,g,h,g,h);c(a.toDataURL("image/png"))};k.src=b}else c(a.toDataURL("image/png"))};d.src=a}
function localJSON(a,b){if("undefined"==typeof b)return a=localStorage[a],"undefined"!==typeof a&&(a=$.parseJSON(a)),a;""===b?delete localStorage[a]:localStorage[a]=JSON.stringify(b)}function showView(a,b,c){"undefined"==typeof c&&(c=170);0<c?($(a).fadeOut(c),$(b).delay(c).fadeIn(c)):($(a).hide(),$(b).show())}function _factory(a,b){return $(a+" "+b).clone()}crapi=new CrAPI;CrAPI.prototype.manifest=function(){return chrome.runtime.getManifest()};CrAPI.prototype.reload=function(){location.reload()};
...
e);b.updateAll($.extend(!0,{},d,e),function(){b.clone(c,function(b){console.debug("Result: %s",JSON.stringify(b));console.groupEnd();a()})})})})})})}catch(f){console.error(f),console.groupEnd()}};/*
 ...
 @version 2.0
*/
modapi=new ModAPI;modapi.manifest=crapi.manifest();
