...
function error(a){showNotificationBar("undefined"==typeof a?"Something <strong>bad</strong> happened.":a,0,"#842f15","white",58)}function restore_options(){var a=$("#email").val();crapi.clone(function(b){var c=0,e=function(){status("Settings restored.")};$(".option").each(function(){var d=$(this).attr("id");d in b[a]||(b[a][d]=d in optionDefaults?optionDefaults[d]:!0,c++);$("#"+d).attr("checked",b[a][d])});c?(console.log("setting defaults..."),crapi.update(a,b[a],e)):e()})}
